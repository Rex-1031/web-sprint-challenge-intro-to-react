...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
        ...
        React JS is a  UI component library.  It was made to manage massive 	amounts of data and state.  You can make  you can make function type items called components which are reusable pieces of code and React created the virtual DOM which is used  to make working with the API DOM easier.

1. Describe component state.

        Component state is how a component decides how will act within its own scope.

1. Describe props.

      Props in React components  are like parameters in vanilla js functions. Props allow you to pass in data into a component for it to render.  Since you are not hard coding the components this makes the component reusable 


1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

        A side effect is anything that affects something outside the scope of a function.  You can sync the effects of the component by adding a dependency array after the callback function of the callback function in the effect hook separated by a comma. To sync it with a state or with props you add that state or prop into that array.  
